...
import net.mffjam2.common.block.GemSocketBlock;
...
public class JamBlocks
{
    ...
    public static final GemSocketBlock  GEM_SOCKET  = null;
    ...
    public static void onBlockRegister(Register<Block> event)
    {
        ...
        registerBlock(event, new GemSocketBlock(Properties.create(Material.IRON)), "gem_socket");
    }
